...
section: "email"
canonical_file: "email-and-patches/send-email.md"
status: "expanded"
---

# `git send-email`

> Esta ruta conserva la clasificación `email`. La guía canónica está en [`email-and-patches/send-email.md`](../email-and-patches/send-email.md). Ambas documentan la misma URL del sitemap.
