...
section: "email"
canonical_file: "sharing-and-updating-projects/request-pull.md"
status: "expanded"
---

# `git request-pull`

> Esta ruta conserva la clasificación `email`. La guía canónica está en [`sharing-and-updating-projects/request-pull.md`](../sharing-and-updating-projects/request-pull.md). Ambas documentan la misma URL del sitemap.
