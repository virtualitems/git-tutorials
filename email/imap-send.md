...
section: "email"
canonical_file: "email-and-patches/imap-send.md"
status: "expanded"
---

# `git imap-send`

> Esta ruta conserva la clasificación `email`. La guía canónica está en [`email-and-patches/imap-send.md`](../email-and-patches/imap-send.md). Ambas documentan la misma URL del sitemap.
