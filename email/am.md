...
section: "email"
canonical_file: "email-and-patches/am.md"
status: "expanded"
---

# `git am`

> Esta ruta conserva la clasificación `email`. La guía canónica está en [`email-and-patches/am.md`](../email-and-patches/am.md). Ambas documentan la misma URL del sitemap.
