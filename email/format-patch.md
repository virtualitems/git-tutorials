...
section: "email"
canonical_file: "email-and-patches/format-patch.md"
status: "expanded"
---

# `git format-patch`

> Esta ruta conserva la clasificación `email`. La guía canónica está en [`email-and-patches/format-patch.md`](../email-and-patches/format-patch.md). Ambas documentan la misma URL del sitemap.
