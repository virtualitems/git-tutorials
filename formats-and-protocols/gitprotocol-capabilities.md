...
| Efecto principal | negociar capacidades en las versiones 0 y 1 del protocolo. | Comprueba el resultado con una orden de lectura. |
...
- La operación observable es: negociar capacidades en las versiones 0 y 1 del protocolo.
...
| --- | --- | --- |
| Caso base | negociar capacidades en las versiones 0 y 1 del protocolo | Ejecuta el ejemplo mínimo y registra el estado antes y después. |
| anuncio | Aplicar las reglas de anuncio. | Cambia una entrada y comprueba el efecto que define la guía. |
| capacidades por servicio | Aplicar las reglas de capacidades por servicio. | Cambia una entrada y comprueba el efecto que define la guía. |
| agente | Aplicar las reglas de agente. | Cambia una entrada y comprueba el efecto que define la guía. |
| side-band | Aplicar las reglas de side-band. | Cambia una entrada y comprueba el efecto que define la guía. |
| compatibilidad | Aplicar las reglas de compatibilidad. | Cambia una entrada y comprueba el efecto que define la guía. |

## Reglas por área

| Área | Regla | Comprobación reproducible |
| --- | --- | --- |
| Anuncio | En v0/v1 las capacidades acompañan la primera referencia anunciada. | Separa el OID y la lista después de NUL. |
| Negociación | El cliente solicita solo capacidades que el servidor anunció. | Rechaza combinaciones no anunciadas. |
| Side-band | Side-band multiplexa pack, progreso y error por banda. | Desmultiplexa el primer byte de cada payload. |
| Agente | agent comunica una versión informativa, no una autorización. | No la uses como única decisión de compatibilidad. |
| Servicio | Upload-pack y receive-pack no comparten todas las capacidades. | Mantén conjuntos separados por servicio. |
