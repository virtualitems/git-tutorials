...
| Efecto principal | organizar ramas, integración y publicación en un equipo. | Comprueba el resultado con una orden de lectura. |
...
- La operación observable es: organizar ramas, integración y publicación en un equipo.
...
| --- | --- | --- |
| Caso base | organizar ramas, integración y publicación en un equipo | Ejecuta el ejemplo mínimo y registra el estado antes y después. |
| ramas de integración | Aplicar las reglas de ramas de integración. | Cambia una entrada y comprueba el efecto que define la guía. |
| ramas temáticas | Aplicar las reglas de ramas temáticas. | Cambia una entrada y comprueba el efecto que define la guía. |
| graduación de cambios | Aplicar las reglas de graduación de cambios. | Cambia una entrada y comprueba el efecto que define la guía. |
| mantenimiento | Aplicar las reglas de mantenimiento. | Cambia una entrada y comprueba el efecto que define la guía. |
| publicación | Aplicar las reglas de publicación. | Cambia una entrada y comprueba el efecto que define la guía. |

## Reglas por área

| Área | Regla | Comprobación reproducible |
| --- | --- | --- |
| Rama temática | Una rama temática contiene un cambio con base identificable. | Publica el punto base y el rango. |
| Integración | La rama de integración reúne cambios que ya pasaron la revisión definida. | Verifica ancestros antes de fusionar. |
| Graduación | Mover un tema entre ramas requiere conservar qué commits se probaron. | Compara rangos con `range-diff`. |
| Mantenimiento | Un mantenedor aplica, revierte o reemplaza temas bajo una política de publicación. | Registra referencias antes de reescribir. |
| Publicación | Las ramas publicadas establecen expectativas sobre reescritura y estabilidad. | Documenta cuáles aceptan force push. |
