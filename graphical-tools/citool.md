...
Este caso usa `git citool` para preparar y crear commits desde una interfaz gráfica.
...
La invocación `git citool` ejecuta esta operación: preparar y crear commits desde una interfaz gráfica. Después, los comandos de consulta confirman el mismo estado que presenta la interfaz.
