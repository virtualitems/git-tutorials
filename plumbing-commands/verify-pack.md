...
canonical_file: "plumbing-read/verify-pack.md"
status: "expanded"
---

# `git verify-pack`

> Esta ruta conserva la clasificación `plumbing-commands`. La guía canónica está en [`plumbing-read/verify-pack.md`](../plumbing-read/verify-pack.md). Ambas documentan la misma URL del sitemap.
