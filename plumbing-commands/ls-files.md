...
canonical_file: "plumbing-read/ls-files.md"
status: "expanded"
---

# `git ls-files`

> Esta ruta conserva la clasificación `plumbing-commands`. La guía canónica está en [`plumbing-read/ls-files.md`](../plumbing-read/ls-files.md). Ambas documentan la misma URL del sitemap.
