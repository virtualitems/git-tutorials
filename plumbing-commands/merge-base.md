...
canonical_file: "plumbing-read/merge-base.md"
status: "expanded"
---

# `git merge-base`

> Esta ruta conserva la clasificación `plumbing-commands`. La guía canónica está en [`plumbing-read/merge-base.md`](../plumbing-read/merge-base.md). Ambas documentan la misma URL del sitemap.
