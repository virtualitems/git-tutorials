...
canonical_file: "plumbing-write/symbolic-ref.md"
status: "expanded"
---

# `git symbolic-ref`

> Esta ruta conserva la clasificación `plumbing-commands`. La guía canónica está en [`plumbing-write/symbolic-ref.md`](../plumbing-write/symbolic-ref.md). Ambas documentan la misma URL del sitemap.
