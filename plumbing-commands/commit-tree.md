...
canonical_file: "plumbing-write/commit-tree.md"
status: "expanded"
---

# `git commit-tree`

> Esta ruta conserva la clasificación `plumbing-commands`. La guía canónica está en [`plumbing-write/commit-tree.md`](../plumbing-write/commit-tree.md). Ambas documentan la misma URL del sitemap.
