...
canonical_file: "plumbing-write/update-ref.md"
status: "expanded"
---

# `git update-ref`

> Esta ruta conserva la clasificación `plumbing-commands`. La guía canónica está en [`plumbing-write/update-ref.md`](../plumbing-write/update-ref.md). Ambas documentan la misma URL del sitemap.
