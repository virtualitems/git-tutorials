...
canonical_file: "scripting-and-helpers/check-ignore.md"
status: "expanded"
---

# `git check-ignore`

> Esta ruta conserva la clasificación `plumbing-commands`. La guía canónica está en [`scripting-and-helpers/check-ignore.md`](../scripting-and-helpers/check-ignore.md). Ambas documentan la misma URL del sitemap.
