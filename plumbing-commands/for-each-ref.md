...
canonical_file: "plumbing-read/for-each-ref.md"
status: "expanded"
---

# `git for-each-ref`

> Esta ruta conserva la clasificación `plumbing-commands`. La guía canónica está en [`plumbing-read/for-each-ref.md`](../plumbing-read/for-each-ref.md). Ambas documentan la misma URL del sitemap.
